...
class SearchForm extends React.Component {
  ...
  getFormWrapper = params => {
    ...
    console.log('formRowArr---->',formRowArr);
    return <Form layout="inline">{formRowArr[0]}</Form>;
  };
  ...
  render() {
    ...
    console.log('SearchForm内部获取到的params为===',params);
    return (
...
SearchForm.propTypes = {
  ...
  */
  ...
  //例如添加等功能button [{name:string,callbackFunc:fun}]
